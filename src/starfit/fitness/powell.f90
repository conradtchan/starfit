...
IMPLICIT NONE
! INTEGER*8, PARAMETER  :: dp = SELECTED_REAL_KIND(12, 60)

PRIVATE
PUBLIC  :: uobyqa, uobyqb, trstep, lagmax
...
INTEGER*8, INTENT(IN)        :: iprint
INTEGER*8, INTENT(IN)        :: maxfun
...
INTEGER*8    :: i, ih, ip, iq, iw, j, jswitch, k, knew, kopt, ksave, ktemp
INTEGER*8    :: nf, nftest, nnp, nptm
...
INTEGER*8    :: i, iterc, j, jp, k, kp, kpp, ksav, ksave, nm
